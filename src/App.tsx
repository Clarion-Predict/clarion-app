...
const _unusedMarkets = [
  {
    ...
    question:
      "Will Love Island USA have a dramatic recoupling in its premiere week?",
    context:
      "Love Island USA returns June 2 on Peacock. Season 7 cast has been announced and fans are already debating alliances.",
    yes: 78,
    no: 22,
    volume: "$12.4k",
    traders: 487,
  ...
  },
  {
    ...
    question: "Will The Traitors US have a double elimination this week?",
    context:
      "Six players remain. The roundtable has been getting more chaotic each episode as alliances fracture.",
    yes: 54,
    no: 46,
    volume: "$9.7k",
    traders: 381,
  ...
  },
  {
    id: 3,
    category: "spotlight",
    show: "Calabasas Confidential",
    question:
      "Will Calabasas Confidential beat its premiere night viewership expectations?",
    context:
      "Premieres May 29. Early buzz has been strong and the Kardashian adjacent cast is drawing attention.",
    yes: 61,
    no: 39,
    volume: "$6.2k",
    traders: 244,
  ...
  // ===== DATING & LOVE =====
  {
    ...
    category: "dating",
    show: "The Bachelor",
    question: "Will the Bachelor finale end with an engagement?",
    context:
      "Season 31 finale airs June 10. Two contestants remain — odds are heavily debated in Bachelor Nation.",
    yes: 74,
    no: 26,
    volume: "$14.1k",
    traders: 509,
  ...
  },
  {
    ...
    category: "dating",
    show: "The Bachelor",
    question: "Will there be a two-on-one date in the next Bachelor episode?",
    context:
      "Previews show a dramatic beach confrontation. Classic two-on-one setup.",
    yes: 82,
    no: 18,
    volume: "$3.4k",
    traders: 178,
  ...
  },
  {
    ...
    show: "Love Is Blind",
    question:
      "Will Love Is Blind Season 8 produce at least two marriages that last a year?",
    context:
      "Seasons 1 and 4 each produced one lasting marriage. Season 8 couples seem stronger on paper.",
    yes: 34,
    no: 66,
    volume: "$8.9k",
    traders: 334,
  ...
  },
  {
    ...
    show: "Love Island USA",
    question:
      "Will a Love Island USA couple from Season 7 still be together six months after the finale?",
    context:
      "Season 7 premieres June 2. Historically only about 30% of couples survive past the show.",
    yes: 41,
    no: 59,
    volume: "$7.3k",
    traders: 289,
  ...
  },
  {
    ...
    question:
      "Will Too Hot To Handle Season 6 be renewed before the finale airs?",
    context:
      "Netflix has pre-announced renewals for this franchise before. Viewership is tracking strong.",
    yes: 47,
    no: 53,
    volume: "$5.6k",
    traders: 221,
  ...
  },
  {
    ...
    show: "90 Day Fiancé",
    question:
      "Will 90 Day Fiancé feature a same-sex couple in its next season?",
    context:
      "The franchise has expanded significantly. Fans have been calling for more diverse casting.",
    yes: 38,
    no: 62,
    volume: "$4.8k",
    traders: 192,
  ...
  },
  {
    ...
    show: "Perfect Match",
    question:
      "Will Perfect Match Season 3 be announced before the end of summer?",
    context:
      "Season 2 performed well for Netflix. Alumni from multiple shows are already being speculated.",
    yes: 63,
    no: 37,
    volume: "$5.1k",
    traders: 203,
  ...
  // ===== COMPETITION =====
  {
    ...
    show: "Survivor",
    question: "Will this season's Survivor winner be a woman?",
    context:
      "Women have won 21 of 46 seasons. The current winner's edit strongly favors two female contenders.",
    yes: 63,
    no: 37,
    volume: "$12.4k",
    traders: 476,
  ...
  },
  {
    ...
    context:
      "Two idols are unaccounted for. The vote tonight is expected to be chaotic.",
    yes: 67,
    no: 33,
    volume: "$4.2k",
    traders: 198,
  ...
  },
  {
    ...
    category: "competition",
    show: "The Traitors US",
    question: "Will a woman win The Traitors US this season?",
    context:
      "Four of the six remaining players are women. The traitor reveal has fans theorizing constantly.",
    yes: 71,
    no: 29,
    volume: "$8.8k",
    traders: 342,
  ...
  },
  {
    ...
    category: "competition",
    show: "Big Brother",
    question: "Will Big Brother 27 cast include a returning player?",
    context:
      "Big Brother has mixed returning players in three of the last five seasons. Casting hints have been vague.",
    yes: 44,
    no: 56,
    volume: "$6.1k",
    traders: 241,
  ...
  },
  {
    ...
    question: "Will RuPaul's Drag Race crown a queen of color this season?",
    context:
      "Queens of color have won 9 of the last 12 seasons. The top 4 remaining all have strong track records.",
    yes: 76,
    no: 24,
    volume: "$7.4k",
    traders: 293,
  ...
  },
  {
    ...
    show: "Beast Games",
    question:
      "Will Beast Games Season 2 be confirmed before Season 1 finale airs?",
    context:
      "MrBeast has hinted at a second season. Amazon hasn't confirmed but viewership numbers were massive.",
    yes: 58,
    no: 42,
    volume: "$9.2k",
    traders: 364,
  ...
  },
  {
    ...
    question: "Will The Amazing Race return for another season in 2026?",
    context:
      "The Amazing Race has been renewed consistently. CBS has been quiet on a Season 36 announcement.",
    yes: 69,
    no: 31,
    volume: "$4.7k",
    traders: 187,
  ...
  // ===== HOUSEWIVES & BRAVO =====
  {
    ...
    show: "RHONY",
    question:
      "Will Bethenny Frankel appear on the Real Housewives of New York reunion?",
    context:
      "Bethenny has been vocal about a potential return. Producers have not confirmed either way.",
    yes: 38,
    no: 62,
    volume: "$11.7k",
    traders: 421,
  ...
  },
  {
    ...
    question: "Will Vanderpump Rules be renewed for another season?",
    context:
      "Viewership rebounded post-Scandoval but Bravo has stayed quiet. Cast contracts are reportedly up.",
    yes: 55,
    no: 45,
    volume: "$9.3k",
    traders: 388,
  ...
  },
  {
    ...
    category: "housewives",
    show: "RHONJ",
    question: "Will there be a physical altercation on this season of RHONJ?",
    context:
      "Tensions between two main cast members have been building for three episodes straight.",
    yes: 79,
    no: 21,
    volume: "$6.8k",
    traders: 267,
  ...
  },
  {
    ...
    category: "housewives",
    show: "Below Deck Med",
    question: "Will Below Deck Med have a crew member fired mid-season?",
    context:
      "Captain Sandy has fired crew members in 3 of the last 5 seasons. Early episodes show serious tension.",
    yes: 62,
    no: 38,
    volume: "$5.4k",
    traders: 214,
  ...
  },
  {
    ...
    category: "housewives",
    show: "Southern Charm",
    question: "Will Southern Charm be renewed for Season 10?",
    context:
      "Season 9 has performed steadily. Bravo has been expanding its lifestyle lineup.",
    yes: 66,
    no: 34,
    volume: "$4.1k",
    traders: 163,
  ...
  },
  {
    ...
    category: "housewives",
    show: "RHOSLC",
    question: "Will RHOSLC have a cast member exit before the reunion?",
    context:
      "At least one cast member has reportedly filmed limited confessionals this season — a classic exit signal.",
    yes: 57,
    no: 43,
    volume: "$7.2k",
    traders: 286,
  ...
  // ===== FAMILY & LIFESTYLE =====
  {
    ...
    question:
      "Will The Kardashians Season 6 feature a major relationship announcement?",
    context:
      "Hulu has been promoting the season heavily. At least two cast members have had relationship news offscreen.",
    yes: 72,
    no: 28,
    volume: "$10.3k",
    traders: 407,
  ...
  },
  {
    ...
    category: "lifestyle",
    show: "Mormon Wives",
    question: "Will Secret Lives of Mormon Wives be renewed for Season 3?",
    context:
      "Season 2 was a massive breakout hit for Hulu. The cast has stayed active and drama has continued offscreen.",
    yes: 81,
    no: 19,
    volume: "$8.6k",
    traders: 341,
  ...
  },
  {
    ...
    show: "Selling Sunset",
    question:
      "Will Selling Sunset introduce a new cast member in the back half of Season 8?",
    context:
      "The show has consistently added cast mid-season. Jason Oppenheim has hinted at new agents joining.",
    yes: 68,
    no: 32,
    volume: "$5.8k",
    traders: 229,
  ...
  },
  {
    ...
    category: "lifestyle",
    show: "Queer Eye",
    question: "Will Queer Eye's final season receive an Emmy nomination?",
    context:
      "The final season was announced recently. The show has received 7 Emmy wins across its run.",
    yes: 59,
    no: 41,
    volume: "$4.4k",
    traders: 174,
  ...
  },
  {
    ...
    show: "Jersey Shore",
    question:
      "Will Jersey Shore Family Vacation film another international trip this season?",
    context:
      "The cast has filmed in Italy and the Bahamas before. Producers have been teasing a new location.",
    yes: 53,
    no: 47,
    volume: "$3.9k",
    traders: 155,
...
const initialCommunityUsers = [
  {
    ...
    positions: [
      {
        marketId: 4,
        market: "Will the Bachelor finale end with an engagement?",
        category: "dating",
        side: "yes",
        amount: 25,
        ts: "2h ago",
      ...
      {
        marketId: 13,
        market: "Will a woman win The Traitors US this season?",
        category: "competition",
        side: "yes",
        amount: 50,
        ts: "1d ago",
  ...
  },
  {
    ...
    positions: [
      {
        marketId: 19,
        market: "Will Vanderpump Rules be renewed for another season?",
        category: "housewives",
        side: "no",
        amount: 30,
        ts: "3h ago",
  ...
  usr_001_4: [
    {
      id: "c1",
      author: "marcuschen",
      text: "Bold call — the edit has been too obvious. They never show the winner this much.",
      ts: "1h ago",
    },
  ],
  usr_002_19: [],
...
const initialSubmissions = [
  {
    id: "sub_001",
    submitter: "BachelorNation_fan",
    source: "community",
    time: "2h ago",
    category: "dating",
    question: "Will the Bachelor skip the fantasy suites this season?",
    context:
      "Lead has made comments in interviews suggesting he wants a different path.",
    endsHint: "Jun 3, 2026",
    autoChecks: {
      publicResolution: true,
      noPerverseIncentive: true,
  ...
  {
    id: "sub_002",
    submitter: "TraitorsFan22",
    source: "community",
    time: "4h ago",
    category: "competition",
    question: "Will the Traitors finale have a live audience this season?",
    context:
      "Peacock has been expanding production on the show. The UK version uses a live studio format.",
    endsHint: "Jun 15, 2026",
    autoChecks: {
      publicResolution: true,
      noPerverseIncentive: true,
      dignity: true,
  ...
  },
  {
    ...
    question:
      "Will a specific Love Island contestant win based on early fan polls?",
    context:
      "Several fan accounts are reporting strong early numbers for one contestant.",
    endsHint: "Aug 1, 2026",
    autoChecks: {
      publicResolution: false,
      noPerverseIncentive: true,
